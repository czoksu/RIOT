...
#define CLOCK_PLL_M         ((CLOCK_HSI / 1000000) / 2)
#define CLOCK_PLL_N         (CLOCK_CORECLOCK / 1000000)
...
#define UART_0_DMA_ISR      isr_dma1_stream7
 ...
 */
#define ADC_CONFIG {              \
    {GPIO_PIN(PORT_A, 5), 1, 5},  \
    {GPIO_PIN(PORT_C, 3), 1, 13},  \
    {GPIO_PIN(PORT_F, 6), 3, 4} \
}
...
static const pwm_conf_t pwm_config[] = {
    {
        ...
        .pins     = { GPIO_PIN(PORT_B,  6), GPIO_PIN(PORT_B, 7),
                      GPIO_PIN(PORT_B, 8), GPIO_PIN(PORT_B, 9) },
        .af       = GPIO_AF2,
        .chan     = 2,
        .bus      = APB1
    },
    {
        ...
        .pins     = { GPIO_PIN(PORT_E, 5), GPIO_PIN(PORT_E, 5),
